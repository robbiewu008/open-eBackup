...
if "%Scanner_Branch%" == "" (
    set Scanner_Branch=debug_OceanProtect_DataBackup_1.6.0_openeBackup_v2
)
if "%Backup_Branch%" == "" (
    set Backup_Branch=debug_OceanProtect_DataBackup_1.6.0_openeBackup_v2
)
...
@REM call %PLUGIN_PATH%\framework\build\build.bat
