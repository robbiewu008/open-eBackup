...
product_name="OceanProtect-DataProtect"
...
sed -i "s/gaussdb_version/${gaussdb_version}/g" ${INF_DOCKERFILE_PATH}/gaussdb.dockerfile
sed -i "s/gaussdb_port/${gaussdb_port}/g" ${INF_DOCKERFILE_PATH}/gaussdb.dockerfile
sed -i "s/gaussdb_version/${gaussdb_version}/g" ${INF_DOCKERFILE_PATH}/gaussdb.name
sed -i "s/kafka_version/${kafka_version}/g" ${INF_DOCKERFILE_PATH}/kafka.dockerfile
sed -i "s/kafka_port/${kafka_port}/g" ${INF_DOCKERFILE_PATH}/kafka.dockerfile
sed -i "s/kafka_version/${kafka_version}/g" ${INF_DOCKERFILE_PATH}/kafka.name
sed -i "s/zookeeper_version/${zookeeper_version}/g" ${INF_DOCKERFILE_PATH}/zookeeper.dockerfile
sed -i "s/zookeeper_port/${zookeeper_port}/g" ${INF_DOCKERFILE_PATH}/zookeeper.dockerfile
sed -i "s/zookeeper_version/${zookeeper_version}/g" ${INF_DOCKERFILE_PATH}/zookeeper.name
sed -i "s/redis_version/${redis_version}/g" ${INF_DOCKERFILE_PATH}/redis.dockerfile
sed -i "s/redis_port/${redis_port}/g" ${INF_DOCKERFILE_PATH}/redis.dockerfile
sed -i "s/redis_version/${redis_version}/g" ${INF_DOCKERFILE_PATH}/redis.name
sed -i "s/elasticsearch_version/${elasticsearch_version}/g" ${INF_DOCKERFILE_PATH}/elasticsearch.dockerfile
sed -i "s/elasticsearch_port/${elasticsearch_port}/g" ${INF_DOCKERFILE_PATH}/elasticsearch.dockerfile
sed -i "s/elasticsearch_version/${elasticsearch_version}/g" ${INF_DOCKERFILE_PATH}/elasticsearch.name
sed -i "s/om_version/${product_version}/g" ${OM_DOCKERFILE_PATH}/om.dockerfile
sed -i "s/om_version/${product_version}/g" ${OM_DOCKERFILE_PATH}/om.name
sed -i "s/sftp_version/${product_version}/g" ${INF_DOCKERFILE_PATH}/sftp.dockerfile
