...
slim_image="euleros-base-aarch64-V200R011C00SPC500B750.tar.xz"
slim_image_name="euleros-base-aarch64"
slim_image_tag="V200R011C00SPC500B750"
PACKAGE1="EulerOS_Server_V200R011C00SPC500B750.tar.gz"
PACKAGE2="devel_tools.tar.gz"
base_euler_yum_url="https://cmc-ctu-artifactory.cmc.tools.huawei.com/artifactory/cmc-software-release/DPA/OS%20DEPENDENCY/1.3.0//arm/euler2.11/"
base_openeuler_yum_url="https://mirrors.tools.huawei.com/openeuler/openEuler-20.03-LTS/everything/aarch64/"
jdk_version="jre1.8.0_422"
jdk_package="jre-8u422-linux-aarch64.tar.gz"
