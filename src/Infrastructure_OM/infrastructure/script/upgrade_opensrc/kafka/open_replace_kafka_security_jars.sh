...
#    cp -af log4j-1.2-api-2.17.1.jar ${KAFKA_PATH}/libs
#    cp -af log4j-api-2.17.1.jar ${KAFKA_PATH}/libs
#    cp -af log4j-core-2.17.1.jar ${KAFKA_PATH}/libs
#    cp -af log4j-slf4j-impl-2.17.1.jar ${KAFKA_PATH}/libs
