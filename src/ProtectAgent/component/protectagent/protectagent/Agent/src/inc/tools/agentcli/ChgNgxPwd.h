 ...
 *
 * @file ChgNgxPwd.h
 * @brief  The implemention about ChgNgxPwd
 * @version 1.0.0.0
 * @date 2020-08-01
...
#ifndef WIN32
#define OPERATION_INPUT_CRT_FAIL_HINT                                       \
    "Change certificate file failed, certificate file must be location at " \
    "${AGENT_ROOT}/nginx/conf directory, please check certificate file exists."
#define OPERATION_INPUT_CRT_KEY_FAIL_HINT                                           \
    "Change certificate key file failed, certificate key file must be location at " \
    "${AGENT_ROOT}/nginx/conf directory, please check certificate file exists."
#else
#define OPERATION_INPUT_CRT_FAIL_HINT                                       \
    "Change certificate file failed, certificate file must be location at " \
...
private:
    ...
    static mp_int32 ChgNginxInfo(const mp_string& strCertificate,
