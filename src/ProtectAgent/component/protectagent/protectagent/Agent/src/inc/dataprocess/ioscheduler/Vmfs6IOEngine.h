 ...
 *
 * @file Vmfs6IOEngine.h
 * @brief  VmfsIO6 interface defination
 * @version 1.0.0.0
 * @date 2023-11-20
 * @author hebaolong 00606494
 */

#ifndef __VMFS6_IO_ENGINE_H__
#define __VMFS6_IO_ENGINE_H__
...
/* support read only */
class Vmfs6IOEngine : public IOEngine {
public:
    Vmfs6IOEngine(Vmfs6IO::VmfsFsT *vmfsptr, const vmware_volume_info& vol, mp_int32 protectType)
        : m_vmfs(vmfsptr), m_volInfo(vol), m_protectType(protectType) {}
    virtual ~Vmfs6IOEngine() = default;
...
private:
    ...
    Vmfs6IO::VmfsFsT *m_vmfs = nullptr;
    Vmfs6IO::VmfsFileT *m_file = nullptr;
    Vmfs6IO::VmfsInoT m_ino = VMFS6_ROOT_INO;
