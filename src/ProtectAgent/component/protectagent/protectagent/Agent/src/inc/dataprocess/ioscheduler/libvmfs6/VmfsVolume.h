#ifndef __VMFS6_VOLUME_H__
#define __VMFS6_VOLUME_H__

#include <stddef.h>

/* === Volume Info === */
#define VMFS6_VOLINFO_BASE 0x100000
#define VMFS6_VOLINFO_MAGIC 0xc001d00d
...
#define VMFS6_VOLINFO_OFFSET_MAGIC offsetof(struct VmfsVolinfoRaw, magic)
#define VMFS6_VOLINFO_OFFSET_VER offsetof(struct VmfsVolinfoRaw, ver)
#define VMFS6_VOLINFO_OFFSET_LUN offsetof(struct VmfsVolinfoRaw, lun)
#define VMFS6_VOLINFO_OFFSET_NAME offsetof(struct VmfsVolinfoRaw, name)
#define VMFS6_VOLINFO_OFFSET_SIZE offsetof(struct VmfsVolinfoRaw, size)
#define VMFS6_VOLINFO_OFFSET_UUID offsetof(struct VmfsVolinfoRaw, uuid)

#define VMFS6_VOLINFO_OFFSET_NAME_SIZE sizeof(((struct VmfsVolinfoRaw *)(0))->name)

/* === LVM Info === */
#define VMFS6_LVMINFO_OFFSET 0x1000
...
#define VMFS6_LVMINFO(field) (VMFS6_LVMINFO_OFFSET + offsetof(struct VmfsLvminfoRaw, field))

#define VMFS6_LVMINFO_OFFSET_SIZE VMFS6_LVMINFO(size)
#define VMFS6_LVMINFO_OFFSET_BLKS VMFS6_LVMINFO(blocks)
#define VMFS6_LVMINFO_OFFSET_UUID_STR VMFS6_LVMINFO(uuidStr)
#define VMFS6_LVMINFO_OFFSET_UUID VMFS6_LVMINFO(uuid)
#define VMFS6_LVMINFO_OFFSET_NUM_SEGMENTS VMFS6_LVMINFO(numSegments)
#define VMFS6_LVMINFO_OFFSET_FIRST_SEGMENT VMFS6_LVMINFO(firstSegment)
#define VMFS6_LVMINFO_OFFSET_LAST_SEGMENT VMFS6_LVMINFO(lastSegment)
#define VMFS6_LVMINFO_OFFSET_NUM_EXTENTS VMFS6_LVMINFO(numExtents)

/*
 * Segment bitmap is at 0x80200.
 * Segment information are at 0x80600 + i * 0x80 for i between 0 and
 * VMFS6_LVMINFO_OFFSET_NUM_SEGMENTS
 *
