...
service ProtectService extends PluginServiceBase {
    ...
    */
    ...
    /**
        ...
        Parameters
            job : check del job information
        Return value
            successful if the ActionResult.code is 0, failed otherwise
    */
    ActionResult AllowDelCopyInLocalNode(1:DelCopyJob job);
    ...
    /**
        ...
        Return value
            successful if the ActionResult.code is 0, failed otherwise
    */
    ActionResult AllowDelCopySubJobInLocalNode(1:DelCopyJob job, 2:SubJob subJob);
}
