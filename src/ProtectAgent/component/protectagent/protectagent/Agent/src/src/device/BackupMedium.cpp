 ...
 *
 * @file BackupMedium.cpp
 * @brief  Contains function declarations about BackupMedium
 * @version 1.0.0
 * @date 2020-08-01
...
mp_int32 BackupMedium::CreateAsmMedium(const mp_string& diskList)
{
    ...
    COMMLOG(OS_LOG_DEBUG, "BuildCreateASMParam parameter is %s.", scriptParams.c_str());
#ifdef WIN32
