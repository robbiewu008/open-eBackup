...
RESGRP_NAME=`GetValue "${PARAM_FILE}" RESGRPNAME`
DEVGRP_NAME=`GetValue "${PARAM_FILE}" DEVGRPNAME`
CLUSTER_TYPE=`GetValue "${PARAM_FILE}" CLUSTERTYPE`
OPER_TYPE=`GetValue "${PARAM_FILE}" OPERTYPE`
