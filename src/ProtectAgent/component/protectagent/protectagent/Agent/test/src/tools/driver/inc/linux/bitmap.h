...
typedef void* BITMAP_ALLOC_FUNCTION_TYPE(uint64_t size, uint32_t tag);
typedef BITMAP_ALLOC_FUNCTION_TYPE* PBITMAP_ALLOC_FUNCTION_TYPE;

typedef void BITMAP_FREE_FUNCTION_TYPE(void* buffer, uint32_t tag);
typedef BITMAP_FREE_FUNCTION_TYPE* PBITMAP_FREE_FUNCTION_TYPE;
