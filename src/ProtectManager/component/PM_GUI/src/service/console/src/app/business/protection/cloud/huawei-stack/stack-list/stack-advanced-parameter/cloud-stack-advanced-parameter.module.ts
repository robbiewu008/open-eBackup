...
import { CloudStackAdvancedParameterComponent } from './cloud-stack-advanced-parameter.component';
import { UpdateIndexModule } from 'app/shared/components/update-index/update-index.module';

@NgModule({
  declarations: [CloudStackAdvancedParameterComponent],
  imports: [
    CommonModule,
    BaseModule,
    ProtectFilterModule,
  ...
  exports: [CloudStackAdvancedParameterComponent]
})
export class CloudStackAdvancedParameterModule {}
