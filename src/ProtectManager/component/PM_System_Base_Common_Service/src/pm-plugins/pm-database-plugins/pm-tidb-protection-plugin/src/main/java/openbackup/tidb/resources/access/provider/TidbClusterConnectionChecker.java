...
@Slf4j
@Component
public class TidbClusterConnectionChecker extends UnifiedResourceConnectionChecker {
    /**
     * tidb service
     */
     ...
     */
    public TidbClusterConnectionChecker(ProtectedEnvironmentRetrievalsService environmentRetrievalsService,
    ...
    public boolean applicable(ProtectedResource object) {
        return Objects.nonNull(object) && ResourceSubTypeEnum.TIDB_CLUSTER.getType().equals(object.getSubType());
    }
    ...
    public Map<ProtectedResource, List<ProtectedEnvironment>> collectConnectableResources(
        ...
        log.info("TidbClusterConnectionChecker,collectConnectableResources,environment.uuid: {}",
            environment.getUuid());
        ProtectedResource clusterResource = tidbService.getResourceByCondition(environment.getUuid());
        clusterResource.getExtendInfo().put(TidbConstants.ACTION_TYPE, TidbConstants.CHECK_CLUSTER);
