...
@Slf4j
@Component
public class NdmpVailderSlaProvider implements SlaValidateProvider {
     ...
     */
    public NdmpVailderSlaProvider(BackupStorageApi backupStorageApi) {
        this.backupStorageApi = backupStorageApi;
    }

    @Override
    public boolean applicable(String object) {
        return Objects.equals(object, ResourceSubTypeEnum.NDMP_BACKUPSET.getType());
    }
