...
@Component
@Slf4j
public class GaussDBAlwaysOnProvider extends DefaultResourceProvider {
    /**
     * 将指定资源特殊字段擦除，避免更新。
     *
     * @param resource 资源
    ...
    public void cleanUnmodifiableFieldsWhenUpdate(ProtectedResource resource) {
        // GaussDB场景下parentName表示实例所属项目名，应设置为可更新
    ...
    public boolean applicable(ProtectedResource object) {
        return Objects.nonNull(object) && Objects.equals(object.getSubType(),
            ResourceSubTypeEnum.HCS_GAUSSDB_INSTANCE.getType());
    }
}
