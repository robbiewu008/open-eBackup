...
class ExchangeRestoreInterceptorTest {
    ...
    private ExchangeRestoreInterceptor exchangeRestoreInterceptorTest;

    @BeforeEach
    void setUp() {
        exchangeRestoreInterceptorTest = new ExchangeRestoreInterceptor(mockExchangeService, copyRestApi, resourceService);
    }
    ...
    void testIntercept() {
        ...
        exchangeRestoreInterceptorTest.initialize(restoreTask);
    ...
    void testGetNode() {
        ...
        environment.setDependencies(dependencies);
        when(mockExchangeService.getEnvironmentById(anyString())).thenReturn(environment);
        exchangeRestoreInterceptorTest.getNode("7017bd24-1a4d-42fc-aaf4-3046eab88704");
    }
