...
@Slf4j
@Component
public class ExchangeMailboxRestoreInterceptor extends AbstractDbRestoreInterceptorProvider {
     ...
     */
    public ExchangeMailboxRestoreInterceptor(ExchangeService exchangeService, CopyRestApi copyRestApi) {
