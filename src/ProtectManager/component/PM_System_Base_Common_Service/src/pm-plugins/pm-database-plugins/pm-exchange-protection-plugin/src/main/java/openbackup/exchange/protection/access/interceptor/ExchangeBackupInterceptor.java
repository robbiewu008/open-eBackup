...
@Slf4j
@Component
public class ExchangeBackupInterceptor extends AbstractDbBackupInterceptor {
     ...
     */
    public ExchangeBackupInterceptor(ExchangeService exchangeService) {
        this.exchangeService = exchangeService;
    }

    @Override
    public boolean applicable(String object) {
        return Arrays.asList(ResourceSubTypeEnum.EXCHANGE_DATABASE.getType(),
            ResourceSubTypeEnum.EXCHANGE_GROUP.getType()).contains(object);
    }
    ...
    public BackupTask supplyBackupTask(BackupTask backupTask) {
        ...
        // 每个节点都执行后置任务
        backupTask.addParameter(DatabaseConstants.MULTI_POST_JOB, Boolean.TRUE.toString());
