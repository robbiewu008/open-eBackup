...
public class OceanBaseTenantBackupInterceptorTest {

    private OceanBaseTenantBackupInterceptor backupInterceptor;
    ...
    public void init() {
        ...
        backupInterceptor = new OceanBaseTenantBackupInterceptor(oceanBaseService, oceanBaseAgentProvider,
            deployTypeService);
    }
    ...
    public void check_applicable_success() {
        boolean applicable = backupInterceptor.applicable(ResourceSubTypeEnum.OCEAN_BASE_TENANT.getType());
    ...
    public void check_supply_backup_task_success() {
        ...
        Assert.assertEquals(list.get(1).getType().intValue(), 2);
    }
