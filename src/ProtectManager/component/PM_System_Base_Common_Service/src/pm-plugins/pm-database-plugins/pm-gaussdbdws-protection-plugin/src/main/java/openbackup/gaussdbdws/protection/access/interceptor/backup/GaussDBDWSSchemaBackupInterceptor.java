...
/**
 * GaussDB(DWS) schema集备份任务下发Provider
 *
 * @author swx1010572
...
@Slf4j
@Component
public class GaussDBDWSSchemaBackupInterceptor extends AbstractDbBackupInterceptor {
     ...
     */
    public GaussDBDWSSchemaBackupInterceptor(LocalStorageService localStorageService,
    ...
    public boolean applicable(String object) {
        return ResourceSubTypeEnum.GAUSSDB_DWS_SCHEMA.getType().equals(object);
    }
}
