...
public class TdsqlLiveMountServiceProviderTest {

    private TdsqlLiveMountServiceProvider tdsqlLiveMountServiceProviderUnderTest;
    @Before
    public void setUp() {
        tdsqlLiveMountServiceProviderUnderTest =
            new TdsqlLiveMountServiceProvider();
    }
    /**
     * 用例场景：TDSQL环境检查类过滤
     * 前置条件：无
    ...
    public void applicable_success() {
        Assert.assertTrue(tdsqlLiveMountServiceProviderUnderTest.applicable(
            ResourceSubTypeEnum.TDSQL_CLUSTERINSTANCE.getType()));
        Assert.assertFalse(tdsqlLiveMountServiceProviderUnderTest.applicable("object"));
    }
    ...
    public void test_build_mysql_livemount_entity_success() {
        mockUserToken();
        TdsqlLiveMountServiceProvider provider = new TdsqlLiveMountServiceProvider();
        ...
        LiveMountEntity liveMountEntity =
            tdsqlLiveMountServiceProviderUnderTest.buildLiveMountEntity(liveMountObject,
