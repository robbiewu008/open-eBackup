...
public class TpopsGaussDBAgentLinkStatusProviderTest {
    private TpopsGaussDBAgentLinkStatusProvider tpopsGaussDBAgentLinkStatusProvider;

    @Before
    public void init() {
        tpopsGaussDBAgentLinkStatusProvider = new TpopsGaussDBAgentLinkStatusProvider();
    }
    ...
    public void applicable_success() {
        ...
        boolean applicable = tpopsGaussDBAgentLinkStatusProvider.applicable(nodeResource1);
    ...
    public void get_link_status_order_success() {
        List<LinkStatusEnum> list = tpopsGaussDBAgentLinkStatusProvider.getLinkStatusOrderList();
