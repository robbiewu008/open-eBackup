...
4.  联系华为工程师下载open-eBackup-bin并解压到当前目录。
5.  下载openEuler到open-eBackup-bin目录下。
...
6.  下载openGauss到open-eBackup-bin目录
...
7.  下载openGauss-Server和openGauss-connector-python-psycopg2到open-eBackup-bin目录下。
...
<tr id="row968734942714"><td class="cellrowborder" valign="top" width="11.39%" headers="mcps1.2.3.1.1 "><p id="p12243240952"><a name="p12243240952"></a><a name="p12243240952"></a>存储网络</p>
</td>
<td class="cellrowborder" valign="top" width="88.61%" headers="mcps1.2.3.1.2 "><p id="p11243104013520"><a name="p11243104013520"></a><a name="p11243104013520"></a>用于生产主机与生产存储之间进行生产数据读写。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="34.63653634636536%" headers="mcps1.2.4.1.2 "><a name="ul43117501388"></a><a name="ul43117501388"></a><ul id="ul43117501388"><li>≥2个/节点</li></ul>
</td>
<td class="cellrowborder" valign="top" width="51.28487151284872%" headers="mcps1.2.4.1.3 "><p id="p69236301581"><a name="p69236301581"></a><a name="p69236301581"></a>当用户有集群高可用需求时，才需要规划内部通信网络。内部通信网络可复用备份网络。</p>
</td>
</tr>
</tbody>
</table>
...
#### Kubenetes集群安装<a name="ZH-CN_TOPIC_0000002033875950"></a>
...
2.  安装MasterServer
    ...
    docker load -i open-eBackup_MasterServer_image/open-eBackup_1.0_MasterServer.tar.xz
